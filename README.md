...
> Lineage: 0 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 3 · Changelog: fresh (2 d)
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package encryption-events -Apply
