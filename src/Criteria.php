 ...
 * - whitelist LIKE:   [ 'entity_table', 'entity_pk', 'field_name', 'op', 'local_key_version', 'outcome', 'error_code' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'id', 'entity_table', 'entity_pk', 'field_name', 'op', 'policy_id', 'local_key_version', 'layers', 'outcome', 'error_code', 'created_at' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'entity_table', 'entity_pk', 'field_name', 'op', 'policy_id', 'local_key_version', 'layers', 'outcome', 'error_code', 'created_at' ], true);
            $parts = [];
