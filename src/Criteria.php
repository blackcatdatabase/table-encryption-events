...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'entity_table', 'entity_pk', 'field_name', 'op', 'policy_id', 'local_key_version', 'layers', 'outcome', 'error_code', 'created_at' ];
    }

    /** Columns used for full-text LIKE/ILIKE searches. */
    protected function searchable(): array
    {
        return [ 'entity_table', 'entity_pk', 'field_name', 'op', 'local_key_version', 'outcome', 'error_code' ];
    }

/** Columns allowed in ORDER BY (falls back to filterable() when empty). */
protected function sortable(): array
{
    return [ 'id', 'entity_table', 'entity_pk', 'field_name', 'op', 'policy_id', 'local_key_version', 'outcome', 'error_code', 'created_at' ];
}
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\EncryptionEvents\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\EncryptionEvents\Definitions::softDeleteColumn();
