...
{
    private EncryptionEventRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new EncryptionEventRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptionEvents\Dto\EncryptionEventDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\EncryptionEvents\Dto\EncryptionEventDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptionEvents\Dto\EncryptionEventDto|null
    {
