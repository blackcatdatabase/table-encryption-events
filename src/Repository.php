...
use BlackCat\Database\Packages\EncryptionEvents\Repository\EncryptionEventRepositoryInterface;
use BlackCat\Database\Packages\EncryptionEvents\Repository\EncryptionEventRepository as GeneratedRepository;
...
{
  private EncryptionEventRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof EncryptionEventRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected EncryptionEventRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptionEvents\Dto\EncryptionEventDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\EncryptionEvents\Dto\EncryptionEventDto|null { return $this->repo->getById($id, $asDto); }
