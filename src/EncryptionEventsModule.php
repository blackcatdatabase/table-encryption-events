...
final class EncryptionEventsModule implements ModuleInterface
{
    public function name(): string { return 'table-encryption_events'; }
    public function table(): string { return 'encryption_events'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_enc_events_entity' ];
        if ($d->isMysql()) {
