...
namespace BlackCat\Database\Packages\EncryptionEvents\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO EncryptionEventDto:
...
final class EncryptionEventDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'policy_id' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [ 'layers' ];
    /** @var string[] */
     ...
     * @return EncryptionEventDto
     */
    public static function fromRow(array $row): EncryptionEventDto
    {
        /** @var EncryptionEventDto */
        return DtoHydrator::fromRow(
            EncryptionEventDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?EncryptionEventDto
    {
     ...
     *
     * @param EncryptionEventDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(EncryptionEventDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(EncryptionEventDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(EncryptionEventDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,EncryptionEventDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,EncryptionEventDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(EncryptionEventDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,EncryptionEventDto>
     */
